...
// ClutchConfigurator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CClutchConfiguratorApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CClutchConfiguratorApp::OnAppAbout)
...
// Создание CClutchConfiguratorApp

CClutchConfiguratorApp::CClutchConfiguratorApp() noexcept
{
	...
	SetAppID(_T("ClutchConfigurator.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CClutchConfiguratorApp

CClutchConfiguratorApp theApp;


// Инициализация CClutchConfiguratorApp

BOOL CClutchConfiguratorApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CClutchConfiguratorDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CClutchConfiguratorView));
	if (!pDocTemplate)
		return FALSE;
...
int CClutchConfiguratorApp::ExitInstance()
{
...
// Обработчики сообщений CClutchConfiguratorApp
...
void CClutchConfiguratorApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
